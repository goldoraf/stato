...
{
    return Stato_I18n_I18n::translate($key, $values);
}

function _f($key, $values = array())
{
    return Stato_I18n_I18n::translatef($key, $values);
}

function _p($key, $count = 0)
{
    return Stato_I18n_I18n::translateAndPluralize($key, $count);
}




class Stato_I18n_Exception extends Exception {}

/**
 * Stato_I18n_I18n and localization class
 *
 * @package Stato
 * @subpackage Stato_I18n_I18n
 */
class Stato_I18n_I18n
{
    ...
    public static function setBackend(Stato_I18n_Backend_Simple $backend)
    {
    ...
    public static function getBackend()
    {
        if (!isset(self::$backend)) 
            self::setBackend(new Stato_I18n_Backend_Simple(self::$dataPaths));
