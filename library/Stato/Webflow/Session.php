...
class Stato_Webflow_Session implements ArrayAccess
{
    private $handler;
    ...
    public function __construct(Stato_Webflow_ISessionHandler $handler = null)
    {
    ...
    private function setHandler(Stato_Webflow_ISessionHandler $handler = null)
    {
...
interface Stato_Webflow_ISessionHandler
{
