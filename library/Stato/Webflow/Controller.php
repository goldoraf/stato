...
class DoubleRespond extends \Exception {}
...
class Controller
{
    ...
    public function __construct(Request $request, Response $response)
    {
        ...
        $this->beforeFilters = new FilterChain();
        $this->afterFilters  = new FilterChain();
        $this->aroundFilters = new FilterChain();
    }
     ...
     * @return void
     */
    public function setSessionHandler(ISessionHandler $handler)
    {
    ...
    private function renderTemplate($template, $locals = array())
    {
        ...
        if (!is_readable($templatePath))
            throw new MissingTemplate($templatePath);
    ...
    private function getTemplatePath($template)
    {
        ...
        throw new MissingTemplate($template);
    }
