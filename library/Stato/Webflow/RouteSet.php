...
class RouteSet
{
    ...
    public function addRouteSet($endPointPath, RouteSet $set)
    {
    ...
    public function addRoute($path, $defaults = array(), $requirements = array())
    {
        ...
        $route = new Route($regexParts, $params, $defaults);
    ...
    public function generate($params)
    {
        if (!array_key_exists('controller', $params))
            throw new RoutingError('No controller provided');
        ...
        throw new RoutingError('No route to match that');
    }
