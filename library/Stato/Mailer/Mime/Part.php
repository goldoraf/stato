...
class Stato_Mailer_Mime_Part extends Stato_Mailer_Mime_Entity
{
    ...
    {
        return Stato_Mailer_Mime_Mime::encode($this->content, $this->getEncoding(), $this->lineLength, $this->eol);
    }
