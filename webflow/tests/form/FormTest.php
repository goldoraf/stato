...
class Stato_FormTest extends PHPUnit_Framework_TestCase
{
    public function setup()
    {
        $this->form = new Stato_Form;
        $this->form->title = new Stato_Form_CharField;
        $this->form->body = new Stato_Form_TextField;
    }
    ...
    public function testIsMultipart()
    {
        ...
        $this->form->file = new Stato_Form_FileField;
    ...
    public function testBindField()
    {
        ...
        $this->assertTrue($this->form->title instanceof Stato_Form_BoundField);
    }
    
    public function testGetNotSetFieldShouldThrow()
    {
        $this->setExpectedException('Stato_Form_Exception');
        $foo = $this->form->foo;
    }
    ...
    {
        $this->form->author = new Stato_Form_CharField(array('initial' => 'Enter your name.'));
    ...
    {
        $this->form->author = new Stato_Form_CharField();
...
EOT;
    ...
    {
        $form = new Stato_Form;
        $form->to = new Stato_Form_EmailField(array('required' => true));
        $form->cc = new Stato_Form_EmailField();
        $form->subject = new Stato_Form_CharField(array('min_length' => 5));
        $form->body = new Stato_Form_TextField;
        $form2 = clone $form;
