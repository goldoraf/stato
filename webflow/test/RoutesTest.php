...
class RoutesTest extends PHPUnit_Framework_TestCase
{
    ...
    public function rec($url)
    {
        return $this->map->recognize_path($url);
    }
    
    public function gen($options)
    {
        return $this->map->generate($options);
    }
    
    public function test_basic_rule()
    {
        $map = new SRouteSet();
    ...
    public function test_basic_rule_with_default_controller()
    {
        $map = new SRouteSet();
    ...
    public function test_simple_rewrites()
    {
        $map = new SRouteSet();
    ...
    public function test_simple_resources_rewrites()
    {
        $map = new SRouteSet();
