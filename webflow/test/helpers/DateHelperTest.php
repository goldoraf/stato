...
EOT;
        $this->assertDomEquals($expect, select_day(new SDate(2006, 3, 31)));
        $this->assertDomEquals($expect, select_day(31));
    }
...
EOT;
        $this->assertDomEquals($expect, select_day(new SDate(2006, 3, 31), array('include_blank' => true)));
        $this->assertDomEquals($expect, select_day(31, array('include_blank' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_day(null));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(new SDate(2006, 3, 31)));
        $this->assertDomEquals($expect, select_month(3));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(new SDate(2006, 3, 31), array('include_blank' => true)));
        $this->assertDomEquals($expect, select_month(3, array('include_blank' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(3, array('include_blank' => true, 'disabled' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(null));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(3, array('use_numbers' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(3, array('add_numbers' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(3, array('use_abbrv' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_month(3, array('use_abbrv' => true, 'add_numbers' => true)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_year(new SDate(2006, 3, 31), array('start_year' => 2001, 'end_year' => 2011)));
        $this->assertDomEquals($expect, select_year(2006, array('start_year' => 2001, 'end_year' => 2011)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_year(new SDate(2006, 3, 31), array('start_year' => 2005, 'end_year' => 2008)));
        $this->assertDomEquals($expect, select_year(2006, array('start_year' => 2005, 'end_year' => 2008)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_year(new SDate(2006, 3, 31), array('start_year' => 2008, 'end_year' => 2005)));
    }
...
EOT;
        $this->assertDomEquals($expect, select_hour(new SDateTime(2006, 3, 31, 1, 29, 35)));
        $this->assertDomEquals($expect, select_hour(1));
    }
...
EOT;
        $this->assertDomEquals($expect, select_minute(new SDateTime(2006, 3, 31, 1, 29, 35)));
        $this->assertDomEquals($expect, select_minute(29));
    }
...
EOT;
        $this->assertDomEquals($expect, select_second(new SDateTime(2006, 3, 31, 1, 29, 35)));
        $this->assertDomEquals($expect, select_second(35));
    }
...
EOT;
        $this->assertDomEquals($expect, select_date(new SDate(2006, 3, 31), array('prefix' => 'date[test]', 'start_year' => 2001, 'end_year' => 2011)));
    }
...
EOT;
        $this->assertDomEquals($expect, date_select('article', 'written_on', $article, array('start_year' => 2001, 'end_year' => 2011)));
    }
...
EOT;
        $this->assertDomEquals($expect, date_select('article', 'written_on', $article, array('order' => array('day', 'month', 'year'), 'start_year' => 2001, 'end_year' => 2011)));
    }
...
EOT;
        $this->assertDomEquals($expect, date_select('article', 'written_on', $article, 
...
EOT;
        $this->assertDomEquals($expect, date_time_select('article', 'written_on', $article, array('start_year' => 2001, 'end_year' => 2011)));
    }
}
