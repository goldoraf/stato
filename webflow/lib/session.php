...
class Stato_Session implements ArrayAccess
{
    private $handler;
    ...
    public function __construct(Stato_ISessionHandler $handler = null)
    {
    ...
    private function setHandler(Stato_ISessionHandler $handler = null)
    {
...
interface Stato_ISessionHandler
{
