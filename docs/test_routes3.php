...
$map->connect('admin', array('controller' => 'admin/general', 'action' => 'index'));

$map->connect('pages/*name', array('controller' => 'articles', 'action' => 'view_page'));

$map->connect('archives/:year/:month/:day', array('controller' => 'archives', 'action' => 'view',
                                            'year' => 2004, 'requirements' => array('year' => '/\d{4}/', 
                                                                                   'day' => '/\d{1,2}/', 
                                                                                   'month' => '/\d{1,2}/')));

$map->connect('articles/:year/:month/:day/:title', array('controller' => 'articles', 
                                                   'action' => 'permalink', 
                                                   'year' => '/\d{4}/', 
                                                   'day' => '/\d{1,2}/', 
                                                   'month' => '/\d{1,2}/'));
...
class SRoutesGenerationTest extends UnitTestCase
{
    function setMap($map)
    {
        $map->draw();
...
$test->addTestCase(new SRoutesGenerationTest());
$test->addTestCase(new SRoutesRecognitionTest());
