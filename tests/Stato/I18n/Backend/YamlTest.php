...
class Stato_I18n_Backend_YamlTest extends Stato_I18n_Backend_SimpleTest
{
    public function setup()
    {
        ...
        $this->backend = new Stato_I18n_Backend_Yaml(dirname(__FILE__) . '/../data/yaml');
    }
    ...
    public function testSave()
    {
        ...
        $backend = new Stato_I18n_Backend_Yaml(dirname(__FILE__) . '/../tmp');
