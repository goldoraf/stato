...
class Stato_Webflow_RouteSetTest extends Stato_Webflow_TestCase
{
    public function testDefaultRoute()
    {
        $set = new Stato_Webflow_RouteSet();
    ...
    public function testRouteWithRequirement()
    {
        ...
        $recognized = true;
        try { $set->recognizePath('/conference/foo'); } catch (Stato_Webflow_RoutingError $e) { $recognized = false; }
    ...
    {
        $blogSet = new Stato_Webflow_RouteSet();
