...
class Stato_Webflow_ControllerTest extends Stato_Webflow_TestCase
{
    ...
    {
        $this->controller->respondText();
        $this->setExpectedException('Stato_Webflow_DoubleRespond');
        $this->controller->respondText();
    }
    ...
    {    
        $this->setExpectedException('Stato_Webflow_MissingTemplate');
    ...
    {
        $this->setExpectedException('Stato_Webflow_ActionNotFound');
