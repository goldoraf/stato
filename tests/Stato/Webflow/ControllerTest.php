...
class ControllerTest extends TestCase
{
    ...
    {
        $this->controller->respondText();
        $this->setExpectedException(__NAMESPACE__ . '\DoubleRespond');
        $this->controller->respondText();
    }
    ...
    {    
        $this->setExpectedException(__NAMESPACE__ . '\MissingTemplate');
    ...
    {
        $this->setExpectedException(__NAMESPACE__ . '\ActionNotFound');
