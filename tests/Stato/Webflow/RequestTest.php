...
class Stato_Webflow_RequestTest extends Stato_Webflow_TestCase
{
    private $request;
    ...
    public function testInvalidMethod()
    {
        ...
        $this->setExpectedException('Stato_Webflow_InvalidHttpMethod');
    ...
    public function testRequestFilesWithSingleFile()
    {
        ...
        $this->assertTrue($file instanceof Stato_Webflow_UploadedFile);
    ...
    public function testRequestFilesWithMultipleFile()
    {
        ...
        $this->assertTrue($files[0] instanceof Stato_Webflow_UploadedFile);
        ...
        $this->assertTrue($files[1] instanceof Stato_Webflow_UploadedFile);
