...
class Stato_Webflow_Forms_InputsTest extends Stato_Webflow_TestCase
{
    public function testTextInput()
    {
        $i = new Stato_Webflow_Forms_TextInput();
    ...
    {
        $i = new Stato_Webflow_Forms_Textarea(array('cols' => 80, 'rows' => 20));
    ...
    {
        $i = new Stato_Webflow_Forms_DateInput();
    ...
    {
        $i = new Stato_Webflow_Forms_DateInput(array('format' => 'd/m/Y'));
    ...
    {
        $i = new Stato_Webflow_Forms_DateTimeInput();
    ...
    {
        $i = new Stato_Webflow_Forms_TimeInput();
    ...
    {
        $i = new Stato_Webflow_Forms_CheckboxInput();
    ...
    {
        $i = new Stato_Webflow_Forms_CheckboxInput(array('disabled' => true));
    ...
    {
        $s = new Stato_Webflow_Forms_Select(array('choices' => array('Marketing', 'IT', 'Commercial')));
    ...
    {
        $s = new Stato_Webflow_Forms_Select(array('choices' => array(1=>'Marketing', 2=>'IT', 3=>'Commercial')));
        $this->assertDomEquals(
            '<select name="service">
    ...
    {
        $s = new Stato_Webflow_Forms_Select(array('choices' => array(
    ...
    {
        $s = new Stato_Webflow_Forms_MultipleSelect(array('choices' => array('Marketing', 'IT', 'Commercial')));
        $this->assertDomEquals(
    ...
    {
        $s = new Stato_Webflow_Forms_CheckboxMultipleSelect(array('choices' => array('Marketing', 'IT', 'Commercial')));
        $this->assertDomEquals(
            '<ul>
    ...
    {
        $s = new Stato_Webflow_Forms_RadioSelect(array('choices' => array('Marketing', 'IT', 'Commercial')));
        $this->assertDomEquals(
            '<ul>
    ...
    {
        $s = new Stato_Webflow_Forms_RadioSelect(array('id' => 'foo_service', 'choices' => array('Marketing', 'IT', 'Commercial')));
        $this->assertDomEquals(
            '<ul>
    ...
    {
        $s = new Stato_Webflow_Forms_RadioSelect(array('choices' => array(
            'languages' => array('PHP', 'Python', 'Ruby'),
            'os' => array('Linux', 'MacOS', 'Windows')
        )));
        $this->assertDomEquals(
    ...
    {
        $s = new Stato_Webflow_Forms_RadioSelect(array('id' => 'foo_skill', 'choices' => array(
            'languages' => array('PHP', 'Python', 'Ruby'),
            'os' => array('Linux', 'MacOS', 'Windows')
        )));
        $this->assertDomEquals(
