...
class MimeTypeTest extends UnitTestCase
{
    ...
    public function test_parse_without_q()
    {
        ...
        $this->assertEqual(SMimeType::parse($accept), array('html', 'xml', 'yaml', 'png', 'text', 'pdf', 'all'));
    }
    ...
    public function test_parse_with_q()
    {
        ...
        $this->assertEqual(SMimeType::parse($accept), array('html', 'xml', 'png', 'pdf', 'text', 'yaml', 'all'));
