...
Ext.extend(Ext.ux.CustomHtmlEditor, Ext.form.HtmlEditor, {
    ...
    createLinkDialog : function() {
        ...
        var pageTree = statoCms.app.createTree('createlink-pages-tab', 'http://fda/admin/pages/nodes');
        pageTree.on('click', function(node, e){
            this.linkDialog.urlField.setValue('/'+node.attributes.path);
        }.createDelegate(this));
        
        var fileTree = statoCms.app.createTree('createlink-files-tab', 'http://fda/admin/files/nodes');
